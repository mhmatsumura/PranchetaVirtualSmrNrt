...
public class FormularioActivity extends AppCompatActivity {
   ...
   /* private void inicializaArrayCidades() {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        MenuItemCompat.getActionView(menu.findItem(R.id.menu_formulario_report)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        MenuItemCompat.getActionView(menu.findItem( R.id.menu_formulario_share)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        MenuItemCompat.getActionView(menu.findItem(R.id.menu_formulario_ok)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
