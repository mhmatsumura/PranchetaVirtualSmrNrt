...
public class ListaServicosEncerradosActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.findItem(R.id.menu_lista_servico_aberto).getActionView().setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        menu.findItem(R.id.menu_lista_servico_share_encerrado).getActionView().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
